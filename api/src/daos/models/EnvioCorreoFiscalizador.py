...
class EnvioCorreoFiscalizador(db.Model):
	...
	#TODO Debe llamarse igual al declarado en el objeto FiscalizadorVOBuilder
	fiscalizador = db.relationship('Fiscalizador', lazy=True, uselist=False)
	#TODO Debe llamarse igual al declarado en el objeto EstadoEnvioCorreoVOBuilder
	estadoEnvioCorreo = db.relationship('EstadoEnvioCorreo', lazy=True, uselist=False)
